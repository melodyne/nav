		...
		<div id="contents" style="margin: 10px 100px 10px 100px;">
			...
			<table>
	           ...
	           <tr>
					...
					<td>
					   <input id="access<?php echo $author['authorid']?>" style="display:none;width: 100px;text-align: center;"  class="inpt_menu" type="text" value="<?php echo $author['test_account']?>">
					   <div class="auth<?php echo $author['authorid']?>"><?php echo $author['test_account']?></div>
					</td>
					<td>
					   <input id="pwd<?php echo $author['authorid']?>" style="display:none;width: 100px;text-align: center;"  class="inpt_menu" type="text" value="<?php echo $author['test_pwd']?>">
					   <div class="auth<?php echo $author['authorid']?>"><?php echo $author['test_pwd']?></div>
					</td>
					<td>
